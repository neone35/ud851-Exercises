...
public class MainActivity extends AppCompatActivity {
    ...
    public void openWebPage(String receivedUrl) {
        Uri parsedUri = Uri.parse(receivedUrl);
        Intent webIntent = new Intent(Intent.ACTION_VIEW, parsedUri);
        if (webIntent.resolveActivity(getPackageManager()) != null) { // check for available app
