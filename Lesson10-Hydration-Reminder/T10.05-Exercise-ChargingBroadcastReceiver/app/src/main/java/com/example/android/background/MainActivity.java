...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingReceiver = new chargingBrodcastReceiver();
        mReceiveFilter = new IntentFilter();
        mReceiveFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mReceiveFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
        // and an IntentFilter
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReceiver, mReceiveFilter);
    }
    ...
    public class chargingBrodcastReceiver extends BroadcastReceiver {
