...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER = "dismiss-notification";
    ...
    private static void issueChargingReminder(Context context) {
        PreferenceUtilities.incrementChargingReminderCount(context); //how many times reminder sent
        NotificationUtils.remindUserBecauseCharging(context); //notification
    }
