...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SEARCH_QUERY_URL_EXTRA)) {
                String queryUrlResult = savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA);
                mUrlDisplayTextView.setText(queryUrlResult);
            }
            if (savedInstanceState.containsKey(SEARCH_RESULTS_RAW_JSON)) {
                String searchRawResults = savedInstanceState.getString(SEARCH_RESULTS_RAW_JSON);
                mSearchResultsTextView.setText(searchRawResults);
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String searchUrlResult = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL_EXTRA, searchUrlResult);
        String jsonRawResult = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_RAW_JSON, jsonRawResult);
    }
