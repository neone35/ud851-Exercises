...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int TASKS_ITEM_ID = 101;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        String authority = TaskContract.AUTHORITY;
        String pathTasks = TaskContract.PATH_TASKS;

        // directory
        uriMatcher.addURI(authority, pathTasks, TASKS);
        // item
        uriMatcher.addURI(authority, pathTasks + "/#", TASKS_ITEM_ID);
